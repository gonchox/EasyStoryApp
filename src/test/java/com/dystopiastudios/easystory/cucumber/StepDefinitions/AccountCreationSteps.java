...
public class AccountCreationSteps extends SpringIntegrationTest {
    ...
    public void i_am_a_user_in_the_register_view_and_filled_the_data() {
        saveUserResource.setUsername("sebastianrodri");
        saveUserResource.setPassword("passcucumber55");
        saveUserResource.setEmail("sebasti5@gmai.com");
        saveUserResource.setFirstName("Cucumber5");
        saveUserResource.setLastName("Cucumb5er.io");
        saveUserResource.setTelephone("789411231");
    }
